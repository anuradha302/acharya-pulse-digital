package com.digitalcampus.app.campusmart
...
fun CampusMartScreen(
    ...
    LaunchedEffect(Unit) {
        shops = SupabaseManager.getCampusShopsByType("CAMPUS_MART")
        isLoading = false
    }
        ...
        LazyColumn(
            ...
            if (selectedCampusShop == null) {
                ...
                if (isLoading) {
                    ...
                    item {
                        Text("No Campus Marts available.")
                    }
                } else {
                    items(shops) { shop ->
                        Card(
